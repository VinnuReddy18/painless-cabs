      ...
      <AnimatePresence>
        {showContent && (
          <motion.div
            ...
            className="min-h-screen bg-gradient-to-b from-gray-900 via-purple-900 to-indigo-900"
          >
            <SpeedometerNav />
            ...
            <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                >
                  <Button size="lg" className="bg-gradient-to-r from-yellow-400 to-yellow-600 hover:from-yellow-500 hover:to-yellow-700 text-gray-900 font-bold shadow-lg text-lg px-8 py-4">
                    Experience Luxury
                  </Button>
                </motion.div>
              </div>
              ...
              >
                <ChevronDown className="w-12 h-12 text-yellow-400 drop-shadow-md" />
              </motion.div>
            </section>

            {/* Mission Section */}
            <section id="mission" className="py-20 bg-gradient-to-r from-gray-900 to-indigo-900">
              <div className="container mx-auto px-4">
                ...
                <div className="flex flex-wrap -mx-4">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <div className="h-full bg-gradient-to-br from-purple-800 to-indigo-900 rounded-lg p-8 flex flex-col justify-center shadow-xl border border-purple-500">
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <div className="h-full bg-gradient-to-br from-indigo-900 to-purple-800 rounded-lg p-8 flex flex-col justify-center shadow-xl border border-indigo-500">
            ...
            <section id="drivers" className="py-20 bg-gradient-to-b from-indigo-900 to-gray-900">
              <div className="container mx-auto px-4">
                <motion.h2
                  className="text-5xl font-bold text-center mb-16 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.8 }}
                  viewport={{ once: true }}
            ...
            <section id="why-us" className="py-20 bg-gradient-to-r from-purple-900 to-indigo-900 text-white">
              <div className="container mx-auto px-4">
                <motion.h2
                  className="text-5xl font-bold text-center mb-16 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600"
                  initial={{ opacity: 0, y: 20 }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                  ...
                  />
                  <FeatureCard
                    icon={<Globe className="w-16 h-16 text-yellow-400 mb-6" />}
            ...
            <section id="contact" className="py-20 bg-gradient-to-b from-gray-900 to-black text-white">
              <div className="container mx-auto px-4 text-center">
                ...
                >
                  ...
                  <Button size="lg" variant="outline" className="border-2 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-gray-900 font-bold shadow-lg text-lg px-8 py-4">
                    Become a Driver
                  </Button>
                </motion.div>
              </div>
