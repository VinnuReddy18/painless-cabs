    ...
    <AnimatePresence>
      {showIntro && (
        ...
        >
          ...
          >
            <motion.div
              className="w-56 h-56 bg-gradient-to-br from-gray-800 via-blue-900 to-gray-900 rounded-full flex items-center justify-center mb-8 mx-auto shadow-lg border-2 border-blue-500"
